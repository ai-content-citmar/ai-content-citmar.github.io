...
(function(){
  ...
  function syncFromBackend(){
    ...
    if (!token) {
      if (typeof showToast === 'function' && window.location.pathname.indexOf('login') === -1) showToast('Anda harus login terlebih dahulu', 'error')
      if (window.location.pathname.indexOf('login') === -1) setTimeout(()=> window.location.href = '/login.html', 700)
